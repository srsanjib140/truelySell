                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row ">
                               ...
                               <div class="alert alert-light-success alert-dismissible fade show border-0 mb-4" role="alert"> <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x close" data-bs-dismiss="alert"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>   {{ session('success') }}</div>
                                ...
                                @endif
                                <div class="col-md-12">
                                    <form class="row g-4" action="{{ route("store.role") }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-md-4">
                                                <label for="name" class="form-label"> {{ $per['name'] }}</label> 
                                        </div>
                                        <div class="col-md-8">
                                            <div class="row">
                                           @foreach ( $per['group'] as $group )
                                           <div class="col-md-4">
                                           
            
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="form-check-default" name="permission_id[]" value=" {{ $group['id'] }}">
...
@endsection
@section('js')
    <!-- Include your JavaScript for this view -->
